import { Avatar, Flex, Text, Box, useColorMode, Portal } from '@chakra-ui/react';
...
function Comment({ comment }) {
  ...
  const iconRef = useRef(null); // Tham chiếu đến biểu tượng <BsThreeDots />
  ...
  useEffect(() => {
    if (showOptions && iconRef.current) {
      ...
      setOptionsPosition({ top: rect.bottom + window.scrollY, left: rect.left + window.scrollX - 140 });
    }
  }, [showOptions]);
          ...
          <Portal>
            ...
            >
              ...
              <Box
                ...
                onClick={handleEdit} // Xử lý sự kiện Edit
              >
                Edit
              </Box>
              <Box
