...
import { Box, Button, IconButton, Input, InputGroup, InputLeftElement, Slider, SliderTrack, SliderFilledTrack, SliderThumb, Text } from '@chakra-ui/react';
...
const ToolsEditor = ({ canvas }) => {
    ...
    const handleGifSelect = (gif) => {
        fabric.Image.fromURL(gif.images.original.url, (img) => {
            img.set({
                left: 50,
                top: 50,
                scaleX: 0.5,
    ...
    const onEmojiClick = (emojiObject) => {
        ...
        emojiImage.onload = () => {
            const fabricImage = new fabric.Image(emojiImage, {
                left: 50,
                top: 50,
    ...
    return (
        <Box height="100%" width="160px" ml="4" justifyContent="space-between" marginTop="10px" position="relative">
            <Box display="flex" alignItems="center"
                boxShadow="2xl" bg="#2d3b48" borderRadius="md"
                mb="6"
            >
                <IconButton
                    icon={<DeleteIcon />}
            ...
            <Box display="flex" alignItems="center"
                ...
                mb="6"
            >
                <IconButton color="black" icon={<PiGifLight />}
                    colorScheme="facebook" _hover={{ bg: 'blue.500' }}
                    onClick={() => setShowGifPicker(!showGifPicker)} fontSize="30px"
                    m="2"
                    ml="4"
                />
                <Text>Add GIF</Text>
            ...
            <Box boxShadow="xl" display="grid" padding="2" borderRadius="2xl">
                <Text mb="2" color="white">Brush Size</Text>
                <Slider
            ...
            <Box boxShadow="xl" display="grid" padding="2" borderRadius="2xl" mt={5}>
                <Button onClick={handleFontChange} mb="4" fontFamily={selectedFont} color="white" fontSize="48" p="10"> Abc</Button>
                <Box>
                    <InputGroup>
                        <InputLeftElement pointerEvents="none" children={<CgColorPicker color="gray" fontSize="24px" />} />
